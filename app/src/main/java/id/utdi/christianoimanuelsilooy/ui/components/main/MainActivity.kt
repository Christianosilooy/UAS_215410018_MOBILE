...
import id.utdi.christianoimanuelsilooy.R
import id.utdi.christianoimanuelsilooy.models.Items
import id.utdi.christianoimanuelsilooy.models.Status
import id.utdi.christianoimanuelsilooy.ui.components.details.BookDetailsScreen
import id.utdi.christianoimanuelsilooy.ui.components.search.SearchScreen
import id.utdi.christianoimanuelsilooy.ui.theme.BooklandTheme
import id.utdi.christianoimanuelsilooy.utils.*
import id.utdi.christianoimanuelsilooy.viewmodels.BookViewModel
import id.utdi.christianoimanuelsilooy.viewmodels.BookViewModelFactory
import com.google.accompanist.insets.LocalWindowInsets
import com.google.accompanist.insets.ProvideWindowInsets
import com.google.accompanist.insets.rememberInsetsPaddingValues

//untuk tab-tab di Bottom Navigation Bar
@Immutable
...
class MainActivity : ComponentActivity() {
    ...
    // Override untuk menangani tombol back
    ...
    // Fungsi onCreate untuk inisialisasi aktivitas
        ...
        // Mendapatkan instance dari aplikasi
        application = (getApplication() as BooklandApplication)
        // Membuat repository dan ViewModel untuk manajemen data buku
        ...
        // Mengatur tata letak utama dengan menggunakan Jetpack Compose
        setContent {
            ...
            // Menggunakan Jetpack Compose untuk mendefinisikan tema dan tata letak
            ProvideWindowInsets {
    ...
    // Fungsi untuk menampilkan app bar (bilah atas)
    @Composable
    fun TopBar() {
    ...
    // Fungsi untuk menampilkan Bottom Navigation Bar
    @Composable
    fun BottomBar() {
